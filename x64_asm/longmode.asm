...
.FlushCS:   
    ...
    mov sp, Main                ; Set up stack so that it starts below Main.
    ...
    mov edi, 0x9000             ; Point edi to a free space bracket.
...
.LoopPageTable:
    ...
    jmp 0x0008:LongMode               ; Load CS with 64 bit segment and flush the instruction cache
...
[BITS 64]      
LongMode:
    ;mov edi, 0x000b8000                ; Display "Hello World!"
    mov edi, 0x000A0000
